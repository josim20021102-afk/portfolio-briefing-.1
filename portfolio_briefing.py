...
def save_detail_report(briefing: str) -> tuple[str, str | None]:
    ...
    body = re.sub(
        r'(https?://[^\s<]+)', 
        r'<a href="\1" target="_blank" style="color: #0366d6; text-decoration: underline;">\1</a>', 
        body
    )
    ...
    document = (
        ...
        "<style>body{font-family:system-ui,-apple-system,sans-serif;line-height:1.55;margin:24px;max-width:860px}"
