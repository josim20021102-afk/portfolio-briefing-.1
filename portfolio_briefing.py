...
def _briefing_to_html(briefing: str) -> str:
    """briefing 텍스트를 HTML로 변환합니다. URL은 클릭 가능한 링크로 처리합니다."""
    import re
...
def save_detail_report(briefing: str) -> tuple[str, str | None]:
    ...
    body = _briefing_to_html(briefing)
    document = (
        "<!doctype html>\n"
        "<html lang=\"ko\">\n"
        ...
        "h1{font-size:22px}main{white-space:normal}"
        "a{color:#0070f3;word-break:break-all}</style></head>\n"
